      ...
      <div className='w-full h-[100vh]'>
        ...
        <div className='lg:flex lg:justify-around items-center lg:relative lg:after:absolute lg:after:w-[2px] after:h-[60vh] after:bg-gray-300 after:left-[40%] after:top-[5%] after:transform-[-50%,-50%]'>
          ...
          className='pt-[1rem] lg:w-[40%]'>
            <p className='flex items-center gap-[10px] py-2'><FaPhoneAlt /> 9838460593</p>
            <p className='flex items-center gap-[10px] py-2'><MdEmail />divyvmishra@gmail.com</p>
            <p className='flex items-center gap-[10px] py-2'><IoLocation />Kandivali(E), Mumbai</p>
          </motion.div>
